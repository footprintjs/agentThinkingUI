...
/* ============================================================
   ...
   ============================================================ */
export function AgentThinkingUI({ trace, theme, labels, icons, brand, metaphor = true, loop = false, live = false, toolMenu = "card", onExplain, onScore, onAttribute, onBacktrack, style, mobile, storageKey, onRender, onSelect, linkResolver, renderDetail }) {
